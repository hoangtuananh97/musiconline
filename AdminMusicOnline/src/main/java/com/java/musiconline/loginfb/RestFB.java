package com.java.musiconline.loginfb;
...
@Component
public class RestFB {
	public static String FACEBOOK_APP_ID = "2548582088699596";
	public static String FACEBOOK_APP_SECRET = "2e77b6afad795a85522553c11a2d6e94";
	public static String FACEBOOK_REDIRECT_URL = "https://localhost:8082/musiconline/login-facebook";
